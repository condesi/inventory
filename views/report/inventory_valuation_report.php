...
<div class="row">
    <div class="col-md-12 pull-right">
      ...
      <div class="col-md-2">
        <div class="form-group">
          <label><?php echo _l('valuation_method') ?></label>
          <select name="valuation_method" id="valuation_method" class="selectpicker" data-live-search="true" data-width="100%">
              <option value="average"><?php echo _l('average_cost'); ?></option>
              <option value="fifo"><?php echo _l('fifo_method'); ?></option>
              <option value="lifo"><?php echo _l('lifo_method'); ?></option>
          </select>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="form-group mtop25">
          <div class="btn-group">
           <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-file-download"></i> Exportar <span class="caret"></span></a>
           <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li class="hidden-xs"><a href="?output_type=P" target="_blank" onclick="inventory_valuation_report_pdf(this); return false;"><?php echo _l('download_pdf'); ?></a></li>
            <li class="hidden-xs"><a href="?output_type=S" target="_blank" onclick="inventory_valuation_report_sunat(this); return false;">Exportar para SUNAT</a></li>
          </ul>
        </div>
             ...
             <table class="table table-bordered table-striped">
              <tbody>
               <tr class="bg-info">
                 ...
                 <th colspan="1" class="text-center">Método</th>
                </tr>
