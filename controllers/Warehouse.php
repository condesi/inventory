...
class warehouse extends AdminController {
	public function __construct() {
		...
		$this->load->helper(['warehouse_helper', 'warehouse_peru_helper', 'warehouse_audit_helper']);
	...
	public function settings($group = '') {
		...
		$data['group'] = $this->input->get('group') ?: $group;

		$data['title'] = _l('settings');
		$data['tab'][] = 'general';
		$data['tab'][] = 'items';
		$data['tab'][] = 'locations';
		$data['tab'][] = 'unit_conversions';
		$data['tab'][] = 'categories';
		$data['tab'][] = 'warehouses';
		$data['tab'][] = 'quality_control';
		$data['tab'][] = 'batch_tracking';
